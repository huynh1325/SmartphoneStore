    ...
    try {
        ...
        <div style={{ padding: 20, fontFamily: "Arial", width: 800, color: "#000", fontSize: 20 }}>
            <h2 style={{ textAlign: "center", fontWeight: "bold", fontSize: 24 }}>HÓA ĐƠN</h2>
            ...
            <tbody>
                ...
                <tr key={item.maChiTietDonHang}>
                    <td style={cellStyle}>{item.tenSanPham ?? item.sanPham?.tenSanPham ?? item.maSanPham}</td>
    ...
    const exportPDF = async () => {
        if (!receiptContent || !showReceipt) return;
